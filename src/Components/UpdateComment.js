		...
		return (
			<div>
				<Modal open={this.state.open}>
    				 ...
    				 <Modal.Content>
	                     <Modal.Description>
	                        <Form onSubmit={() => this.updateComment(this.props.selectedComment)}>
    						   <TextArea placeholder='Tell us more' value={this.state.commentValue} onChange={this.handleChange} required />
